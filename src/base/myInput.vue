...
const emits = defineEmits(['passContent'])
...
<template>
    <input type="text" class="myInput" placeholder="账号 / 手机号" @input="throttleInput" v-model="content"
        @compositionstart="inputChinese">
    <div class="preix-icon" :class="{ hidden: flag }">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" t="1690454548697" class="icon"
            viewBox="0 0 1024 1024" version="1.1" p-id="17544" width="16" height="16">
            <path
